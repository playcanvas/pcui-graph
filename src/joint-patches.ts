 ...
 *
 * The V.prototype.transform getter is overridden to return the parent-relative
 * transform (via getTransformToElement) instead of the local node matrix that
 * JointJS 4.x returns by default. This preserves the behaviour that the graph
 * rendering code was written against; removing it may break element positioning.
 *
